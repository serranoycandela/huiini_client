...
class Ui_MainWindow(QMainWindow, guiV2.Ui_MainWindow):
    ...
    def hazResumenDiot(self,currentDir):
        ...
        self.tex_path = os.path.join(self.esteFolder,"resumenDiot.tex")
        self.getTemplate("templateDiot.jinja").stream(context).dump(self.tex_path)
        try:
        ...
        #Popen([self.pdflatex_path, "-output-directory", os.path.join(self.esta_carpeta,"pdfs"),self.tex_path]) 
    ...
    def cualCarpeta(self):
        ...
        if esteFileChooser.exec_():
            ...
            for factura in self.listaDeFacturasOrdenadas:
                ...
                factura.conviertemeEnPDF(self.esteFolder)
